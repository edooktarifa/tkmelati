...
const Layout = ({ children }) => {
    return (
        <div className="min-h-screen bg-background font-sans">
            ...
            {/* Footer */}
            <footer className="bg-white dark:bg-gray-900 text-gray-600 dark:text-gray-300 py-12 border-t border-blue-50 dark:border-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="border-t border-gray-100 dark:border-gray-800 pt-8 text-center text-sm">
